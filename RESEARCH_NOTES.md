...
| 跨宇宙 | hs300失效 | csi500/csi2000通过,hs300谨慎(3/4,安慰剂过) | csi500/csi2000通过,hs300未测 |
...
- [x] **用刷新后的total_share数据（覆盖到2026-04）重新跑WF滚动验证**——完成，五合一(hp=21)拿到4个窗口(此前只有1个)，test_IC全部稳定在0.14-0.15，test_IR全部接近1.0，decay全部为负
- [x] **五合一补充hs300/csi500/csi2000跨宇宙验证**——完成，csi2000最强(IC=0.143,4/4满分)，csi500稳健(IC=0.102)，hs300修正为"谨慎观察"而非"完全失效"(五合一安慰剂检验通过,3/4 PASS,但MaxDD-79.4%不建议直接部署)
